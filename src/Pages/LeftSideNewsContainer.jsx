...
export const LeftSideNewsContainer = () => {
  ...
  const CallData = async () => {
    let promise = await fetch(
      "https://newsapi.org/v2/top-headlines?country=in&page=2&apiKey=b66b09c463ac4dbe9df0657afa6c8a7b"
    );
    let d = await promise.json();
    setData(d.articles);
    let promise2 = await fetch(
      "https://newsapi.org/v2/everything?q=bollywood&apiKey=b66b09c463ac4dbe9df0657afa6c8a7b"
    );
    ...
    <LeftSideNewsContainerStyle>
      <div id="div1">
        ...
        >
          ...
          >
            <span style={{ color: "#00b1cd", fontSize: "20px" }}>[</span>LATEST
            NEWS<span style={{ color: "#00b1cd", fontSize: "20px" }}>]</span>
          </div>
        ...
        {data?.map((el, i) => {
          ...
          if (el.description) {
            if (el.description[0] !== "<") {
              ...
              return (
                <div className="LeftNewsDiv"  key={el.id}>
                  <div>
                    <div className="LeftNewsDes pointer">{title}</div>
                    <MainNewsTimeDiv>
                      <MainNewsPubDate >
                      
                        Updated on {month} {date}, {year} {hour}:{min} {zone}{" "}
                        IST
                      </MainNewsPubDate>
                    </MainNewsTimeDiv>
                  </div>
