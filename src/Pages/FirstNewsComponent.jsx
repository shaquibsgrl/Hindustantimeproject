...
export const FirstNewsComponent = ({el,title,month,date,year,hour,min,zone,heading,id}) => {
  ...
  return (
    ...
    <div className='MainNewsTimeFirstDiv'>
        ...
        <div> 
            <i style={{padding:"10px 12px",fontSize:"22px",color:"#2f2f2f"}} className="fa-solid fa-share-nodes"></i>
            {saved?<i onClick={handleRemove}  style={{padding:"10px 0px 10px 13px",fontSize:"22px",color:"#2f2f2f"}} className="fas fa-bookmark"></i>:<i onClick={handleSaved}  style={{padding:"10px 0px 10px 13px",fontSize:"22px",color:"#2f2f2f"}} class="fa-regular fa-bookmark"></i>}
        </div>
    </div>
    </div>
  )
