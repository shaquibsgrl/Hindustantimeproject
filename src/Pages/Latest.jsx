...
export const Latest = () => {
  ...
  const CallData = async () => {
    let promise = await fetch(
      "https://newsapi.org/v2/everything?q=latest&apiKey=81cd23c204f349be81345237249f7737"
    );
  ...
  return (
    <MainNewsContainerStyle>
      ...
      >
        <span style={{ color: "#00b1cd" }}>Home</span> / Latest News
      </div>
      <div
      ...
      >
        ...
        >
          <span className="bracketHome">[</span>LATEST NEWS
